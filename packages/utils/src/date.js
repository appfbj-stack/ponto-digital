 ...
 */
export function formatDateTimeInZone(date, timezone = 'America/Sao_Paulo') {
 ...
 */
export function formatDateInZone(date, timezone = 'America/Sao_Paulo') {
    const d = typeof date === 'string' ? parseISO(date) : date;
 ...
 */
export function formatTimeInZone(date, timezone = 'America/Sao_Paulo') {
    const d = typeof date === 'string' ? parseISO(date) : date;
 ...
 */
export function toUtcFromZone(localDate, timezone) {
 ...
 */
export function fromUtcToZone(utcDate, timezone) {
 ...
 */
export function formatMinutesAsHMS(totalSeconds) {
 ...
 */
export function endOfDayInZone(date, timezone) {
    const local = fromUtcToZone(date, timezone);
 ...
 */
export function listDaysOfMonth(year, month, timezone = 'America/Sao_Paulo') {
    const days = [];
